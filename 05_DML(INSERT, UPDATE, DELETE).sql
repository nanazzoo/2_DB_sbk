...
-- 2. UPDATE(내용을 변경/추가하여 최신화/새롭게하다)
...
UPDATE EMPLOYEE2 
SET SALARY = (SELECT SALARY FROM EMPLOYEE2 e WHERE EMP_NAME = '유재식'), 
...
SELECT * FROM EMP_M01; 
SELECT * FROM EMP_M02; -- 5명(기존 4명 신규1명)
...
DELETE FROM EMPLOYEE2 e WHERE EMP_NAME = '장채현';
