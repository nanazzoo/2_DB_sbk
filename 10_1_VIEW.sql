...
/* VIEW
 	...
 	- 논리적 가상 테이블
 	  --> 테이블 모양을 하고 있지만 실제 값을 저장하지는 않음
 
 	** VIEW 사용 목적 **
 		1) 복잡한 SELECT문을 쉽게 재사용 하기 위해
...
--	INSERT 시 NULL이 삽입되는데 ('D0' 'NULL' 'L3')

--	만약 VIEW에 포함되지 않은 컬럼(DEPT_TITLE)에
--	NOT NULL 제약조건이 설정되어 있는 경우
--	정상적인 INSERT가 진행되지 않는다
	--> ORA-01400: NULL을 ("KH_SBK"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다
